...
return [
    ...
    'policy' => [
        ...
        'path'      => 'app'.DIRECTORY_SEPARATOR.'Policies'.DIRECTORY_SEPARATOR.'Cms',
    ],
    ...
    'test' => [
        ...
        'api_path_prefix' => 'cms-api',
    ],

    'database_seeder_path' => 'database'.DIRECTORY_SEPARATOR.'seeds'.DIRECTORY_SEPARATOR.'DatabaseSeeder.php',
    'route_path'           => 'routes'.DIRECTORY_SEPARATOR.'cms-api.php',
];
